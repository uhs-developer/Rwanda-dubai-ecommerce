        ...
        <div class="container">
            <div class="header-content">
                ...
                <div class="header-actions">
                    <!-- Account -->
                    <a href="#" class="header-action-btn" aria-label="<?php esc_attr_e('Account', 'dubaidirect-rwanda'); ?>">
                    ...
                    <!-- Cart -->
                    <a href="#" class="header-action-btn cart-link" aria-label="<?php esc_attr_e('Cart', 'dubaidirect-rwanda'); ?>">
