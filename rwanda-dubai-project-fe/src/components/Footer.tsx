      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Connecting Dubai's premium electronics and auto parts market 
              with Rwanda through reliable shipping and authentic products.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              {[
                ...
                { label: "Returns & Warranty", action: () => navigate('/returns') },
