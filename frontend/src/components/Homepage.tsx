      ...
      <section className="py-24 bg-gradient-to-r from-gray-600 via-slate-600 to-gray-700 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          <div className="max-w-4xl mx-auto animate-fade-in">
            ...
            <div className="max-w-lg mx-auto flex flex-col lg:flex-row gap-4 mb-8">
              <input
                type="email"
              ...
              <Button
                size="lg"
                className="bg-white text-gray-600 hover:bg-gray-50 shadow-lg hover:shadow-xl transition-all duration-300 px-8 py-4 text-lg font-semibold rounded-xl w-full lg:w-auto"
              >
                {t("footer.subscribe")}
              </Button>
            </div>
