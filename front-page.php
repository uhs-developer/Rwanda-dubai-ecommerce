            ...
            <div class="category-grid">
                <div class="category-card">
                    <div class="category-image">
                        <img src="https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400&h=400&fit=crop"
                            alt="Electronics">
                    </div>
                    <div class="category-content">
                        <h3 class="category-title">Electronics</h3>
                        <p class="category-description">Smartphones, laptops, tablets, and home appliances.
                            Quality-assured electronics with comprehensive warranty.</p>
                ...
                <div class="category-card">
                    ...
                    <div class="category-content">
                        ...
                        <p class="category-description">Engine components, electrical systems, and performance parts.
                            Genuine parts with compatibility guarantee.</p>
                ...
                <div class="category-card">
                    ...
                    <div class="category-content">
                        ...
                        <p class="category-description">Latest iPhone, Samsung, and premium Android devices. Unlocked
                            and ready for Rwandan networks.</p>
                ...
                <div class="category-card">
                    <div class="category-image">
                        <img src="https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=400&h=400&fit=crop"
                            alt="Laptops">
                    </div>
                    <div class="category-content">
                        <h3 class="category-title">Laptops</h3>
                        <p class="category-description">MacBook, Dell, HP, and Lenovo laptops. Perfect for business,
                            education, and creative work></p>
                ...
                <div class="category-card">
                    ...
                    <div class="category-content">
                        ...
                        <p class="category-description">Refrigerators, washing machines, air conditioners, and smart
                            home devices for modern living.</p>
                            ...
                            <div class="subcategory-item">
                                <div class="subcategory-icon">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2">
                                        <path
                                            d="M3 7l9-4 9 4M4 20h16a2 2 0 002-2V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                    </svg>
                                </div>
                ...
                <div class="category-card">
                    <div class="category-image">
                        <img src="https://images.unsplash.com/photo-1562141964-9d3c5a7124b0?w=400&h=400&fit=crop"
                            alt="Performance Parts">
                    </div>
                    <div class="category-content">
                        <h3 class="category-title">Performance Parts</h3>
                        <p class="category-description">Exhaust systems, suspension components, and performance upgrades
                            for enhanced vehicle performance</p>
